...
```
We are increasingly living in a digitally designed world. AFter reading Qadri's aricle on Pakistan's digitally created family and kinship databases, I have been pursuaded to consider how social biases are getting incorporated into the digital world and what can we do to address that. To put it in an everyday context we are incresingly using various online identity verification databases to prove identity at our work, at the doctor's clinic, at the bank and also at government service agencies such as the Service Ontario and last but not the least at the airport or at any port of entry. Out of all these data systems I have encountered, I think the systems of hierarchy I have expeienced at the airport is very telling of the global inequality and unequal power dynamic between countries. Those who hold a weaker passport has to go through extra screening, security check and unexpected rude behaviour from immigration authorities despite having valid travel documents. In comparison people with strong passports can easily pass through immigration and in some cases visas are not even required. In other instances I have encountered inherent sexism such as women can only choose titles such as Miss and Mrs on a webform which indicates her marital status , however men can be identified with only Mr. Many countries have updated their national databases with a gender X for people who do not identify as male or female. However those changes are often politically fraught over and can be overturned as well, if the political climate shifts. Upon reflection it becomes clear that the digitization of national population databases and even smaller organziational databases can be plagued by the societal and ideological biases of the database creators and thus can create additional barrier to equality and fair access services in the daily life.
```
